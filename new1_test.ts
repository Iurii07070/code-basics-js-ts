...
I.waitForVisible("//div[contains(text(),'Yuriy Presnov')]",cons.wait);
I.waitForVisible("//div[contains(text(),'yuriy.presnov@flowhealth.com')]");
I.waitForVisible("//div/span[contains(text(),'+1 202 888 9999')]");
});
